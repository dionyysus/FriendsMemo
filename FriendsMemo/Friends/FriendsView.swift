                    ...
                    if pages.isEmpty {
                        ...
                        TabView(selection: $currentPage) {
                            ForEach(0..<pages.count, id: \.self) { index in
                                // Wrap each page in a NavigationLink
                                NavigationLink(destination: FreeformNoteView(book: book, pageContent: pages[index])) {
                                    Text(pages[index])
                                        .font(.title)
                                        .padding()
...
//                        ForEach(0..<pages.count, id: \.self) { index in
//                            // Wrap each page in a NavigationLink
//                            NavigationLink(destination: Text("Details for \(pages[index])")) {
//                                Text(pages[index])
//                                    .font(.title)
//                                    .padding()
//                                    .frame(maxWidth: 350, maxHeight: 450)
